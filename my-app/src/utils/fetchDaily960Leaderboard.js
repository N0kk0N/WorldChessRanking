export async function fetchLeaderboardData() {
    ...
    async function fetchCountryName(countryUrl) {
        ...
        const excludedLabels = ['European Union', 'International', 'Asia', 'Africa', 'North America', 'South America', 'Oceania', 'Antarctica', 'Europe', 'United Kingdom', 'Seychelles', 'Taiwan', 'Bosnia-Herzegovina'];
